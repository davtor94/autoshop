        ...
        <div id="main">
            ...
            <div class="row">
                <div class="col-md-3 col-12">
                    ...
                    <button class="btn btn-outline-dark btn-block btn-lg shadow" >Eliminar</button>
                    <button class="btn btn-outline-dark btn-block btn-lg shadow" >Modificar</button>
                    ...
                    <div class="card text-white bg-secondary mb-3 shadow">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-center my-0"><a href="{{action('AdminController@cobrar',['user_id'=> $vehicle->user_id,'cita_id'=> $appoinment->id])}}
                                        " class="btn btn-outline-light  btn-lg">Detalles</a> </p>
                        </div>
    ...
    <div class="container-fluid col-md-6 col-8 " id="createCita" >
        <form action="{{url('addcitas')}}/" method="post" >
            ...
            <div class="form-row mt-3">
                ...
                <div class="form-group col-md-6">
                    <label for="inputPassword4">Número teléfono</label>
                    <input type="number" class="form-control" id="celphone">
                </div>
            </div>
            <div class="form-group">
                <label for="exampleFormControlTextarea1">Descripción de la falla</label>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select id="horario" class="form-control" name="hora" >
                        <option value="horarios Disponibles">horarios Disponibles</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="gridCheck">
                        Enviar correo para recordarle de la cita
                    </label>
                </div>
            </div>
            <div class="row mb-4">
