...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row pt-0 mt-0">
            <div class="col-4 text-center px-0 py-0 mx-0 my-0 shadow"> <button onclick="addCita()" class="btn btn-outline-secondary btn-block btn-lg">Agregar</button> </div>
            <div class="col-4 text-center px-0 py-0 mx-0 my-0 shadow"> <button class="btn btn-outline-secondary btn-block btn-lg">Eliminar</button> </div>
            <div class="col-4 text-center px-0 py-0 mx-0 my-0 shadow"> <button class="btn btn-outline-secondary btn-block btn-lg">Modificar</button> </div>
        </div>
        <div class="row">
        ...
        <form action="{{url('addVehicle')}}/" method="post">
            ...
            <div class="form-row mt-3">
                <div class="form-group col-md-6">
                    <label for="inputEmail4">Número de placas</label>
            ...
            <div class="form-row mt-3">
                <div class=" form-group col-md-12">
                    <label for="inputdate">Color</label>
                    <input type="text" class="form-control" name="color" id="inputdate" placeholder="Negro">
                </div>
            </div>
